...
// #53 core extraction: learnKey() is pure (learn/queue.ts, also core,
// needs it) and now lives in @jargonslayer/core/learn/keys — re-
// exported below so existing "@/lib/learn/store" call sites (and this
// file's own makeInitialLearnRecord) keep working unchanged.
import { learnKey } from "@jargonslayer/core/learn/keys";
