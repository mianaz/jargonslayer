...
#[tauri::command]
pub fn system_translate_probe(app: tauri::AppHandle, source: String, target: String) -> Result<SysTranslateProbeResult, String> {
...
#[tauri::command]
pub fn system_translate_prepare(app: tauri::AppHandle, source: String, target: String) -> Result<u64, String> {
...
#[tauri::command]
pub fn system_translate(app: tauri::AppHandle, items: Vec<TranslateItem>, source: String, target: String) -> Result<Vec<TranslateItem>, String> {
...
/// comment gives.
#[tauri::command]
pub fn system_translate_stop(app: tauri::AppHandle, generation: Option<u64>) -> Result<(), String> {
