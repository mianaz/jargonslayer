...
[![Tests](https://img.shields.io/badge/tests-4866%20passing-4ADE80?style=flat-square&labelColor=121212)](apps/web/src/lib/__tests__)
...
JargonSlayer 同时收录系统音频和麦克风两路声音，回声消除后自动标注为「我」和「对方」。本地 Whisper、系统识别、系统翻译都在本机运行，音频和文字不出这台 Mac。中英双语的实时字幕逐句滚动，会议结束一键把双语纪要存进 Obsidian 或 Notion。遇到黑话，还会顺手弹一张中文解释卡片。
